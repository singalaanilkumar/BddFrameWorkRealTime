...
public class AddEmployeeForHrmPage1 {
    WebDriver driver;
    ...
    WebElement gettingName;

    /*initializing the page objects*/
    public AddEmployeeForHrmPage1(WebDriver rDriver) {
        driver = rDriver;
    ...
    public Employee AddEmployeeActions() throws AWTException, IOException, InterruptedException {
        ...
        CommonActions.clickingOnWebElement(Save, 8);

        Thread.sleep(6000);
        String name = gettingName.getText();
        Integer age = 23;
        Integer salary = 500000;
    ...
    public void setData() throws InterruptedException {
        ...
        Thread.sleep(2000);
        CommonActions.selectCalendar("15", "May", "2023");
    ...
    public void SelectCheckboxAndSave() {
        CommonActions.clickingOnWebElement(smokerCheckbox, 4);
        CommonActions.clickingOnWebElement(saveButtonOnPersonalDetails, 4);
    }
}
